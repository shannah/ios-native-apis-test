 ...
 * @author Shai Almog
 */
public class IOSNativeTestStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "IOSNativeTest";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new IOSNativeTestStub());
    }
